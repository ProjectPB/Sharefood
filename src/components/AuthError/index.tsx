...
const AuthError: React.FC<Props> = ({ error }) => {
  ...
  useEffect(() => {
    switch (error) {
      ...
      case "auth/requires-recent-login":
        setNewErr(LANG.ERRORS.REQUIRES_RECENT_LOGIN);
        break;
      default:
        setNewErr(error)
        break;
  ...
  }, [error, LANG.ERRORS.REQUIRES_RECENT_LOGIN, LANG.ERRORS.INVALID_USERNAME, LANG.ERRORS.INVALID_EMAIL, LANG.ERRORS.INVALID_PASSWORD, LANG.ERRORS.PASSWORDS_VARY, LANG.ERRORS.EMAIL_NOT_FOUND, LANG.ERRORS.EMAIL_ALREADY_EXISTS, LANG.ERRORS.TOO_MANY_REQUESTS, LANG.ERRORS.USER_DISABLED, LANG.ERRORS.USER_NOT_FOUND, LANG.ERRORS.WRONG_PASSWORD]);
